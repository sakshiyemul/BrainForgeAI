...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch("https://brainforgeai-backend.onrender.com/users/login", {
        method: "POST",
        headers: {
      ...
      if (!response.ok) {
        setMessage({
          text: data.message || "Invalid email or password. Please check your credentials.",
          type: "error",
        });
        setLoading(false);
        return;
      ...
      setMessage({
        text: "Unable to connect to backend server. Please verify the service is running.",
        type: "error",
      });
      setLoading(false);
    }
    ...
    <div className="auth-split-container">
      ...
      <div className="auth-hero-pane">
        ...
        <main className="auth-hero-main" style={{ opacity: 1 }}>
          ...
          >
            BrainForge AI helps you organize{" "}
            <span
        ...
        <footer className="hero-telemetry-footer">
          ...
          {/* Graphical network nodes matching reference layout */}
          ...
          <div className="auth-card-header">
            ...
            <p>
              {selectedRole === "ADMIN"
                ...
                : "Sign in to access your knowledge workspace and chats."}
            </p>
          </div>

          {/* Role Selector Segment Pill */}
          <div className="role-segment-pill">
            <button
              type="button"
              className={`role-btn ${selectedRole === "USER" ? "active-role" : ""}`}
          ...
          <form onSubmit={handleLogin}>
            <div className="auth-input-group">
              <label className="auth-input-label">
                {selectedRole === "ADMIN" ? "ADMINISTRATIVE EMAIL" : "EMAIL ADDRESS"}
              </label>
              <div className="auth-input-wrapper">
                ...
                <input
                  ...
                  placeholder={
                    selectedRole === "ADMIN" ? "admin@brainforgeai.com" : "user@example.com"
                  }
                  value={email}
            ...
            <div className="auth-sub-actions">
              <button
                ...
                onClick={() =>
                  alert("To reset your credentials, please contact your system administrator.")
                }
              >
                Forgot password?
              </button>
